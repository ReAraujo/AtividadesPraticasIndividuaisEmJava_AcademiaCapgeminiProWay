...
public class ClienteController {
    ...
    @GetMapping("/cliente") // Mapeando requisição tipo 'get' para a rota "/cliente" - tipo 'get' mostra os parâmetros inseridos na url
    ...
    @PostMapping("/cliente/salvar") // Mapeando requisição tipo 'post' para rota "/cliente/salvar" - tipo 'post' = mantem as informações ocultas na url
